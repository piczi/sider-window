  ...
  const addBookmark = () => {
    try {
      const newBookmark: Bookmark = {
        ...
        url: currentUrl,
        favicon: `https://www.google.com/s2/favicons?domain=${new URL(currentUrl).hostname}`
      };
                      ...
                      {bookmarks.length > 0 ? (
                        bookmarks.map(bookmark => (
                          ...
                          >
                            {bookmark.favicon && (
                              <Box mr={2}>
                                <img src={bookmark.favicon} alt="favicon" width="16" height="16" />
                              </Box>
                            )}
                        ...
                        <Text color="gray.500" py={2} textAlign="center">暂无自定义书签</Text>
                      )}
                      <Box 
                        p={2} 
                        borderWidth="1px" 
